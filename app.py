...
def load_css():
    ...
    /* GIỮ NGUYÊN TOÀN BỘ HEADER CỦA STREAMLIT ĐỂ NÚT ☰ LUÔN HOẠT ĐỘNG. */
    header[data-testid="stHeader"] {
        background:rgba(8,7,13,.78) !important;
        backdrop-filter:blur(10px);
    }
    /* Không dùng display:none/visibility:hidden cho vùng chứa nút ☰. */
